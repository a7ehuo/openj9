...
public class DDRBackfillLayoutTest {
	...
	private static void createAndCheckValueType() throws Throwable {
		...
		Object[] flatUnAlignedSingleBackfill2Array = ValueClass.newArrayInstance(
			NullRestrictedCheckedType.of(ValueTypeTests.flatUnAlignedSingleBackfillClass2), 3);
			flatUnAlignedSingleBackfill2Array[1] = flatUnAlignedSingleBackfill2Instance;

		Object[] quadLongArray = ValueClass.newArrayInstance(
			NullRestrictedCheckedType.of(ValueTypeQuadLong.class), 3);
