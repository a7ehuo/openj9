...
J9::ValuePropagation::constrainRecognizedMethod(TR::Node *node)
   ...
   if (isLoadFlattenableArrayElement || isStoreFlattenableArrayElement)
      ...
      bool canTransformNotFlattenedVTArrayElementLoadStore = false;
      if (arrayConstraint &&
          (isCompTypeVT == TR_yes) &&
      ...
      else if (canTransformNotFlattenedVTArrayElementLoadStore
...
J9::ValuePropagation::transformFlattenedArrayElementLoad(TR_OpaqueClassBlock *arrayClass, TR::Node *callNode)
    ...
    *    public final MultipleFieldsPrimitive vtFiled0;
    *    public final MultipleFieldsPrimitive vtFiled1;
    * }
    *
    * Before:
    * n50n      treetop
    ...
    * n3043n        iloadi  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled0.x
    * n3042n          aladd
    * n45n 	            aload  <parm 1 [QNestedFieldsPrimitive;>
    * n3041n            ladd
    * n3039n              lmul
    ...
    * n3038n                lconst 16
    * n3040n              lconst 16
    * n3044n        iloadi  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled0.y
    * n3042n          ==>aladd
    * n3045n        iloadi  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled1.x
    * n3042n          ==>aladd
    * n3046n        iloadi  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled1.y
    * n3042n          ==>aladd
    */
...
bool
J9::ValuePropagation::transformFlattenedArrayElementStore(TR_OpaqueClassBlock *arrayClass, TR::TreeTop *callTree, TR::Node *callNode)
   {
   /*
    * primitive public class MultipleFieldsPrimitive {
    *    public final int x;
    ...
    * After:
    * n9n       treetop
    * n8n         istorei  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled0.x
    * n3123n        aladd
    * n3n             aload  <parm 1 [QNestedFieldsPrimitive;>
    * n3122n          ladd
    * n3120n            lshl
    ...
    * n3119n              iconst 4
    * n3121n            lconst 16
    * n3124n        iloadi  NestedFieldsPrimitive.vtFiled0.x
    * n5n             aload  <parm 2 QNestedFieldsPrimitive;>
    * n3156n    istorei  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled0.y
    * n3153n      ==>aladd
    * n3155n      iloadi  NestedFieldsPrimitive.vtFiled0.y
    * n5n           ==>aload
    * n3158n    istorei  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled1.x
    * n3153n      ==>aladd
    * n3157n      iloadi  NestedFieldsPrimitive.vtFiled1.x
    * n5n           ==>aload
    * n3160n    istorei  <Q-NestedFieldsPrimitive-array-shadow>.vtFiled1.y
    * n3153n      ==>aladd
    * n3159n      iloadi  NestedFieldsPrimitive.vtFiled1.y
    * n5n           ==>aload
    *
    */
   TR_OpaqueClassBlock *arrayComponentClass = fe()->getComponentClassFromArrayClass(arrayClass);
...
J9::ValuePropagation::doDelayedTransformations()
   ...
   for (ValueTypesHelperCallTransform *callToTransform = valueTypesHelperCallsToBeFolded.getFirst();
      ...
      if (isLoad && !isFlattenedElement)
         ...
         isCallTreeRemoved = transformFlattenedArrayElementStore(callToTransform->_arrayClass, callTree, callNode);
         }
