...
class TreeLowering : public TR::Optimization
   ...
   class Transformer
     ...
     /**
       ...
       */
      /**
       *                     TreeLowering::Transformer
       *                      ^      lower(node, tt) ^
       *                      |          ^           |
       *         +------------+          |           +------------+
       *         |                       |                        |
       *         |                       |                        |
       *  AcmpTransformer    ArrayStoreCHKTransformer     otherTransformer
       *     lower(node, tt)         lower(node, tt)        lower(node, tt)
       */
   ...
   class TransformationManager
      ...
      struct Transformation
         ...
         inline void doTransformation() { transformer->lower(node, tt); }
         };
