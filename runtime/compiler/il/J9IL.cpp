...
TR::ILOpCodes J9::IL::opCodeForIndirectCompactReadBarrier(TR::DataType dt)
{
    return OMR::IL::opCodeForIndirectReadBarrier(dt);
}

TR::ILOpCodes J9::IL::opCodeForIndirectCompactLoad(TR::DataType dt)
{
    if (dt.isOMRDataType()) {
        return OMR::IL::opCodeForIndirectLoad(dt);
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectCompactStore(TR::DataType dt)
{
    if (dt.isOMRDataType()) {
        return OMR::IL::opCodeForIndirectStore(dt);
    }
...
TR::ILOpCodes J9::IL::opCodeForIndirectCompactWriteBarrier(TR::DataType dt)
{
    return OMR::IL::opCodeForIndirectWriteBarrier(dt);
}
