...
private:
    ...
    TR::Node *widenIntLoadForCompactFieldIfRequired(TR::Node *value, TR::SymbolReference *symRef,
        bool isFieldBoolean = false, bool isFieldChar = false);
    TR::Node *narrowIntStoreForCompactFieldIfRequired(TR::Node *value, TR::SymbolReference *symRef,
